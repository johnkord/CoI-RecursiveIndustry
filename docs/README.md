...
This directory contains the public design and contributor documentation for
Recursive Industry.
...
| [RELEASE_NOTES_0.22.0c.md](RELEASE_NOTES_0.22.0c.md) | Current public playtest scope, installation warning, and exact artifact identity |
| [RELEASE_NOTES_0.22.0b.md](RELEASE_NOTES_0.22.0b.md) | Preserved predecessor playtest scope and artifact identity |

Historical experiments, private test responses, game-derived datasets, and
superseded design drafts are intentionally not published here.
